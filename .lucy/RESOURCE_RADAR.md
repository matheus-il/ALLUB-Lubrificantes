...
Consulta: Planejar a aplicacao Allub Lubrificantes, mobile-first, cadastro de clientes e produtos, com orcamento zero e persistencia free tier  
...
6. @product-design
   Nome: product-design
   Descricao: Design de produto nivel Apple — sistemas visuais, UX flows, acessibilidade, linguagem visual proprietaria, design tokens, prototipagem e handoff. Cobre Figma, design systems, tipografia, cor,...
   Trecho: ...>>Comandos<<
...
7. @analytics-product
   Nome: analytics-product
   Descricao: Analytics de produto — PostHog, Mixpanel, eventos, funnels, cohorts, retencao, north star metric, OKRs e dashboards de produto. Ativar para: configurar tracking de eventos, criar funil de...
   Trecho: ...>>Comandos<<
...
8. @amazon-alexa
   Nome: amazon-alexa
   Descricao: Integracao completa com Amazon Alexa para criar skills de voz inteligentes, transformar Alexa em assistente com Claude como cerebro (projeto Auri) e integrar com AWS ecosystem (Lambda, DynamoDB,...
   Trecho: ...>>de<< voz inteligentes, transformar >>Alexa<< >>em<< >>assistente<< >>com<< Claude >>como<<...
